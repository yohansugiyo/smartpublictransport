package travel.kiri.smarttransportapp.view;
...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	public SlidingUpPanelLayout(Context context, AttributeSet attrs,
		...
		if (attrs != null) {
			...
			if (ta != null) {
				...
				mParalaxOffset = ta.getDimensionPixelSize(
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			int childTop;
			if (mIsSlidingUp) {
				childTop = lp.slideable ? slidingTop
	...
	private int getSlidingTop() {
		if (mSlideableView != null) {
			return mIsSlidingUp ? getMeasuredHeight() - getPaddingBottom()
					- mSlideableView.getMeasuredHeight() : getPaddingTop();
		}
	...
	private class DragHelperCallback extends ViewDragHelper.Callback {
		...
		public void onViewReleased(View releasedChild, float xvel, float yvel) {
			int top = mIsSlidingUp ? getSlidingTop() : getSlidingTop()
					- mSlideRange;
			...
			if (mAnchorPoint != 0) {
				...
				if (mIsSlidingUp) {
					...
					anchoredTop = mPanelHeight
							- (int) (mAnchorPoint * mSlideRange);
					anchorOffset = (float) (mPanelHeight - anchoredTop)
							/ (float) mSlideRange;
				}
